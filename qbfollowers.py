...
r = requests.get("https://api.linkedin.com/v1/companies/2845325/company-statistics:(follow-statistics:(countsByMonth))", params=payload)
...
# 	#cur.execute("INSERT INTO flash(Total_IOP_Signups, Total_IOP_Billed) VALUES('" + str(a[i]) + "', '" + str(b[i]) + "')" )
 	#cur.execute("INSERT INTO DemandForce(Num_Followers, Timestamp) VALUES('" + followers + "', '" + dt + "')" )
 		cur.execute("INSERT INTO QuickBase(Num_Followers, Timestamp) VALUES('" + str(followers) + "', '" + str(dt) +"')")
